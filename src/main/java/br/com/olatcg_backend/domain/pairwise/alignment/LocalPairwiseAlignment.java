...
public class LocalPairwiseAlignment extends PairwiseAlignment {

    public LocalPairwiseAlignment() {
        type = AlignmentTypeEnum.LOCAL;
    }
    ...
    protected SequencePair<DNASequence, NucleotideCompound> performAlign(DNASequence sequenceA, DNASequence sequenceB, SimpleGapPenalty gapPenalty, SubstitutionMatrix<NucleotideCompound> matrix) {
        return Alignments.getPairwiseAlignment(sequenceA, sequenceB, Alignments.PairwiseSequenceAlignerType.LOCAL, gapPenalty, matrix);
    }
